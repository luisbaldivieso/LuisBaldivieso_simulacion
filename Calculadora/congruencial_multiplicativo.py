...
ventana.title("Congruencial Multiplicativo")
...
tk.Label(
    ventana,
    text="MÉTODO CONGRUENCIAL MULTIPLICATIVO",
    font=("Arial",18,"bold")
).pack(pady=10)
...
tk.Label(frame,text="Módulo (m):",font=("Arial",12)).grid(row=2,column=0,padx=10,pady=5)
entrada_m = tk.Entry(frame,font=("Arial",12),width=10)
entrada_m.grid(row=2,column=1)
...
for col in columnas:
    ...
    tabla.column(col, width=170, anchor="center")
